      ...
      <NavigationStylingContainer>
        <div className="relative w-full h-full lg:max-w-[1240px] flex items-center justify-between sm:px-[30px] xl:px-0 z-[2]">
          ...
          <div className="sm:hidden pr-[24px]">
            ...
            <label
              htmlFor="menu-toggle"
              className="fixed inset-0 bg-black/50 z-40 opacity-0 pointer-events-none transition-opacity duration-300 ease-in-out peer-checked:opacity-100 peer-checked:pointer-events-auto"
            ></label>
